...
<head>
  ...
  <!--THIS CSS FILES BELONG TO THE OLD CMS-->
...
<!--   <link rel="stylesheet" href="css/vendor/bootstrap.min.css">-->
  <!-- REMEMBER TO UNCOMMENT THE MAIN BOOTSTRAP CSS 😎😎😎😎😎😎 -->
  <!-- styles -->
...
<!--    Body CSS-->
    <!--=============== css  ===============-->
    <link type="text/css" rel="stylesheet" href="css/css/reset.css">
    <link type="text/css" rel="stylesheet" href="css/css/plugins.css">
<!--    <link type="text/css" rel="stylesheet" href="css/css/style.css">-->
    <link type="text/css" rel="stylesheet" href="css/css/color.css">
<!--    THE ERROR IS FROM MY CUSTOM CSS FILE-->
...
<body>
  ...
  <div class="page-loader">
    ...
    <div class="page-loader-info">
      ...
      <p class="page-loader-info-title">My CMS</p>
      <!-- /PAGE LOADER INFO TITLE -->
